...
<head>
  ...
  <title>Control Automotriz | Vehículos</title>
      ...
      <div class="container-fluid">
          <!-- /.col-md-6 -->
            <div class="card card-primary ">
              ...
              <div class="card-body">
                <h6 class="card-title">Listado de vehículo</h6><br/>
                <div class="row">
                  <div class="form-group">
                  <br>
                      <button type="button" class="btn btn-success mr-2" onclick="location.href='../views/Vehiculo/vehiculoCreate.php'"> + Registrar Vehículo</button>
                    </div>
                </div>
                <div class="row">
                  <div class="col-lg">
